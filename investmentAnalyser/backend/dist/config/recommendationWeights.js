...
exports.RECOMMENDATION_WEIGHTS = void 0;
...
const weightSum = exports.RECOMMENDATION_WEIGHTS.risk +
    exports.RECOMMENDATION_WEIGHTS.horizon +
    exports.RECOMMENDATION_WEIGHTS.goal +
    exports.RECOMMENDATION_WEIGHTS.liquidity +
    exports.RECOMMENDATION_WEIGHTS.fit;
if (Math.abs(weightSum - 1.0) > 0.0001) {
    throw new Error(`RECOMMENDATION_WEIGHTS must sum to 1.0, but got ${weightSum}`);
}
